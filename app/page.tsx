...
const visualStylePresets = {
  ...
  high_key_portrait: { label: "高调清透人像", prompt: "High-key cinematic portrait look. Bright, clean and luminous image with soft flattering light. Fair translucent skin with a very subtle, low-intensity rosy undertone and gentle natural warmth. Keep the complexion evenly toned across the entire face, with soft diffuse color transitions and restrained, uniform blush. Avoid distinct circular cheek blush, isolated red patches, strong red cheeks, makeup-like rouge, or sudden localized redness. Lips may retain only a natural muted pink. Use a neutral-to-slightly-cool white balance, fresh colors and controlled saturation. Avoid yellow or orange skin tones. Preserve realistic skin texture without excessive smoothing." },
